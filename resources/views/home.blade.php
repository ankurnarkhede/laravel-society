...
<div class="row" id="login-page">
    ...
    <div class="col s12 z-depth-5 card-panel">
        <form action=" {{ url('/login') }}" class="login-form" enctype="multipart/form-data" method="post" style="width: 400px;">
            <div class="row" style="margin-bottom: 0px;">
                <div class="input-field col s12 center">
                    <img alt="" class="circle responsive-img valign profile-image-login" src="assets/images/home-logo.png" style="width: unset;">

                    <p class="center login-form-text">SOCIETY</p>
