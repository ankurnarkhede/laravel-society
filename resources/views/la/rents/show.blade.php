...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $rent->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Rents", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/rents/'.$rent->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Rents", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.rents.destroy', $rent->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/rents') }}" data-toggle="tooltip" data-placement="right" title="Back to Rents"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'flat_number')
						@la_display($module, 'block')
						@la_display($module, 'owner_name')
						@la_display($module, 'members')
