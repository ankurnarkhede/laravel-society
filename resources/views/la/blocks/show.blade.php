	...
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $block->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Blocks", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/blocks/'.$block->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Blocks", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.blocks.destroy', $block->id], 'method' => 'delete', 'style'=>'display:inline']) }}
